...
BAN_LOG_CHANNEL_ID = 1466542559730991164  # canal separado para logs de ban
...
def _get_font(size: int, bold: bool = False):
    ...
    raise FileNotFoundError('Nenhuma fonte TTF válida encontrada para o log. Coloque as fontes em ./fonts/')
